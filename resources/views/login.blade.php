...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <img class="mx-auto h-20 w-auto" src="https://justatic.com/v/20240613150453/branding/logos/justia.svg" alt="Your Company">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="{{ route('login') }}" method="POST">
            ...
            <div>
                <button type="submit" class="flex w-full justify-center rounded-md bg-[#06357a] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#06357a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
            </div>
        </form>
